    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(auto_now_add=True)),
                ('category_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='common.category')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('PS', 'Point of Sale'), ('IM', 'Inventory Management'), ('AD', 'Administration')], max_length=2, null=True)),
